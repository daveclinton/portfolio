      ...
      <Flex flexDir="column" maxW={{ base: "400px", md: "650px" }}>
        ...
        <UnorderedList>
          ...
          <ListItem mt="10px">
            ...
            JavaScript applications using TypeScript and integrating it with
            React.
          </ListItem>
          <ListItem mt="10px">
            <strong>Python:</strong> Strong understanding of the Python
            programming language and experience building web applications using
          ...
          <ListItem mt="10px">
            ...
            knowledge of data modeling, indexing, and performance tuning in
            MongoDB.
          </ListItem>
          <ListItem mt="10px">
            <strong>Cypress: </strong>Experience with end-to-end testing using
            Cypress, including testing user flows, data validation, and handling
            asynchronous requests.
          </ListItem>
          <ListItem mt="10px">
            <strong> Website development:</strong> Skilled in using HTML, CSS,
            and JavaScript for creating responsive, mobile-friendly websites.
          </ListItem>
          <Heading
            as="h6"
            fontSize="24px"
          ...
          <ListItem mt="10px">
            <strong> Jira Administration: </strong>Proficient in setting up and
            configuring Jira projects, customizing workflows, managing users,
            and integrating Jira with other tools.
          </ListItem>
          <ListItem mt="10px">
            <strong>Confluence Administration:</strong> Experience with creating
            and managing Confluence spaces, customizing templates, and
            integrating Confluence with other tools.
          </ListItem>
          <ListItem mt="10px">
            <strong>Jira/Confluence Customization: </strong>Skilled in creating
            custom Jira plugins and customizing the Jira/Confluence UI to meet
            specific client needs.
          </ListItem>
          <ListItem mt="10px">
            <strong>Jira/Confluence Scripting: </strong>Experience with writing
            Jira/Confluence scripts in Groovy for automating tasks and
            integrating Jira/Confluence with other tools.
          </ListItem>
          <Heading
            as="h6"
            fontSize="24px"
          ...
          <ListItem mt="10px">
            ...
            technical documents, user manuals, API documentation and knowledge
            base articles using tools like Microsoft Word, Confluence, AsciiDoc,
            Markdown and LaTeX. Skilled in explaining complex technical concepts
          ...
          <ListItem mt="10px">
            Knowledge of documentation best practices, such as content design,
            user testing, and version control.
          </ListItem>
          <Heading
            as="h6"
            fontSize="24px"
          ...
          <ListItem mt="10px">
            ...
            building and customizing Wordpress websites, including themes and
            plugins.
          </ListItem>
          <ListItem mt="10px">
          ...
          <ListItem mt="10px">
            <strong>Wordpress Security: </strong>Knowledge of best practices for
            securing Wordpress websites and experience with implementing
            security measures to protect Wordpress sites.
          </ListItem>
          <ListItem mt="10px">
            <strong>Wordpress Performance Optimization: </strong>Experience in
            optimizing Wordpress sites for performance, including caching,
          ...
          <ListItem mt="10px">
            ...
            including meta tags, structured data, and content optimization.
          </ListItem>
        </UnorderedList>
      </Flex>
    </Flex>
